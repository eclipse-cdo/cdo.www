...
if ($result && mysql_num_rows($result) > 0)
{
	...
	{
		print '<tr><td width="20%" height="130" align="left" valign="top">' .
...
if ($email_all)
{
	print '<a href="mailto:' . $email_all . '?subject=[CDO] "><img border="0" src="' . $projectPath . '/images/email_all.gif" alt="EMail All"/></a>';
}
